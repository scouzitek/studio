  ...
  de: {
    ...
    legal: {
      privacyPolicy: {
        ...
        content: `Zuletzt aktualisiert: 26. Juli 2024\n\nDiese Datenschutzrichtlinie beschreibt Unsere Richtlinien und Verfahren zur Erhebung, Nutzung und Weitergabe Ihrer Daten, wenn Sie den Dienst nutzen, und informiert Sie über Ihre Datenschutzrechte und wie das Gesetz Sie schützt.\n\n<h3>Interpretation und Definitionen</h3>\n<h4>Interpretation</h4>\nWörter, deren Anfangsbuchstabe großgeschrieben ist, haben unter den folgenden Bedingungen definierte Bedeutungen. Die folgenden Definitionen haben dieselbe Bedeutung, unabhängig davon, ob sie im Singular oder im Plural erscheinen.\n\n<h4>Definitionen</h4>\nFür die Zwecke dieser Datenschutzrichtlinie:\n\n<strong>Konto</strong> bezeichnet ein einzigartiges Konto, das für Sie erstellt wurde, um auf unseren Dienst oder Teile unseres Dienstes zuzugreifen.\n\n<strong>Unternehmen</strong> (bezeichnet als "das Unternehmen", "Wir", "Uns" oder "Unser" in dieser Vereinbarung) bezieht sich auf Novix.\n\n<strong>Personenbezogene Daten</strong> sind alle Informationen, die sich auf eine identifizierte oder identifizierbare Person beziehen.\n\n<strong>Dienst</strong> bezieht sich auf die Anwendung.\n\n<strong>Nutzungsdaten</strong> beziehen sich auf automatisch erhobene Daten, die entweder durch die Nutzung des Dienstes oder durch die Infrastruktur des Dienstes selbst generiert werden (zum Beispiel die Dauer eines Seitenbesuchs).\n\n<h3>Erhebung und Nutzung Ihrer personenbezogenen Daten</h3>\n<h4>Arten der erhobenen Daten</h4>\n<strong>Personenbezogene Daten</strong>\nWährend der Nutzung unseres Dienstes können wir Sie bitten, uns bestimmte persönlich identifizierbare Informationen zur Verfügung zu stellen, die zur Kontaktaufnahme oder Identifizierung von Ihnen verwendet werden können. Persönlich identifizierbare Informationen können unter anderem Nutzungsdaten umfassen.\n\n<strong>Nutzungsdaten</strong>\nNutzungsdaten werden automatisch bei der Nutzung des Dienstes erhoben. Nutzungsdaten können Informationen wie die Internet-Protokoll-Adresse Ihres Geräts (z.B. IP-Adresse), Browsertyp, Browserversion, die Seiten unseres Dienstes, die Sie besuchen, die Uhrzeit und das Datum Ihres Besuchs, die auf diesen Seiten verbrachte Zeit, eindeutige Gerätekennungen und andere diagnostische Daten enthalten.\n\n<h4>Verwendung Ihrer personenbezogenen Daten</h4>\nDas Unternehmen kann personenbezogene Daten für folgende Zwecke verwenden:\n\nUm unseren Dienst bereitzustellen und zu warten, einschließlich der Überwachung der Nutzung unseres Dienstes.\n\nZur Verwaltung Ihres Kontos: zur Verwaltung Ihrer Registrierung als Benutzer des Dienstes.`
      },
      termsOfService: {
  ...
  it: {
    ...
    legal: {
      privacyPolicy: {
        ...
        content: `Ultimo aggiornamento: 26 luglio 2024\n\nQuesta Informativa sulla privacy descrive le nostre politiche e procedure sulla raccolta, l'uso e la divulgazione delle tue informazioni quando utilizzi il Servizio e ti informa sui tuoi diritti alla privacy e su come la legge ti protegge.\n\n<h3>Interpretazione e Definizioni</h3>\n<h4>Interpretazione</h4>\nLe parole di cui la lettera iniziale è maiuscola hanno significati definiti nelle seguenti condizioni. Le seguenti definizioni avranno lo stesso significato indipendentemente dal fatto che appaiano al singolare o al plurale.\n\n<h4>Definizioni</h4>\nAi fini della presente Informativa sulla privacy:\n\n<strong>Account</strong> indica un account univoco creato per consentirti di accedere al nostro Servizio o a parti del nostro Servizio.\n\n<strong>Azienda</strong> (indicata come "l'Azienda", "Noi", "Ci" o "Nostro" nel presente Accordo) si riferisce a Novix.\n\n<strong>Dati Personali</strong> sono qualsiasi informazione che si riferisce a un individuo identificato o identificabile.\n\n<strong>Servizio</strong> si riferisce all'Applicazione.\n\n<strong>Dati di Utilizzo</strong> si riferisce ai dati raccolti automaticamente, generati dall'uso del Servizio o dall'infrastruttura del Servizio stessa (ad esempio, la durata di una visita a una pagina).\n\n<h3>Raccolta e Utilizzo dei Tuoi Dati Personali</h3>\n<h4>Tipi di Dati Raccolti</h4>\n<strong>Dati Personali</strong>\nMentre utilizzi il Nostro Servizio, potremmo chiederti di fornirci alcune informazioni di identificazione personale che possono essere utilizzate per contattarti o identificarti. Le informazioni di identificazione personale possono includere, ma non sono limitate a: Dati di utilizzo.\n\n<strong>Dati di Utilizzo</strong>\nI Dati di Utilizzo vengono raccolti automaticamente durante l'utilizzo del Servizio. I Dati di Utilizzo possono includere informazioni quali l'indirizzo del protocollo Internet del tuo dispositivo (ad es. indirizzo IP), tipo di browser, versione del browser, le pagine del nostro Servizio che visiti, l'ora e la data della tua visita, il tempo trascorso su tali pagine, identificatori di dispositivo univoci e altri dati diagnostici.\n\n<h4>Uso dei Tuoi Dati Personali</h4>\nL'Azienda può utilizzare i Dati Personali per i seguenti scopi:\n\nPer fornire e mantenere il nostro Servizio, incluso per monitorare l'utilizzo del nostro Servizio.\n\nPer gestire il Tuo Account: per gestire la tua registrazione come utente del Servizio.`
      },
      termsOfService: {
